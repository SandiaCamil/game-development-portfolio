...
[![Ver código](https://img.shields.io/badge/VER_CÓDIGO-2c2c2c?style=for-the-badge)](index.html)
...
Esta práctica (Proceso de desarrollo) planteaba el siguiente problema: la organización ambiental *EcoAcción* detectó que gran parte de la comunidad, especialmente jóvenes y niños, no sabe separar correctamente los residuos reciclables. Sin equipo propio de desarrollo, contrataron equipos externos para aplicar el **proceso formal de desarrollo de videojuegos** (pre-producción, producción, testeo y lanzamiento) y entregar una primera solución funcional en poco tiempo.
...
<td align="center"><a href="versions/v2-slingshot.html">Ver</a></td>
</tr>
<tr>
